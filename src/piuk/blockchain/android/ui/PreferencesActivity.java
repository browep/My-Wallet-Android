...
public final class PreferencesActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findPreference(KEY_ABOUT_CREDITS_BITCOINJ).setSummary(
				Constants.CREDITS_BITCOINJ_URL);
		findPreference(KEY_ABOUT_CREDITS_ZXING).setSummary(
				Constants.CREDITS_ZXING_URL);
		findPreference(KEY_ABOUT_CREDITS_ICON).setSummary(
				Constants.CREDITS_ICON_URL);
		...
		findPreference(KEY_ABOUT_BITCOIN_WALLET_FOR_ANDROID).setSummary(
				Constants.CREDITS_BITCON_WALLET_ANDROID);
	...
	public boolean onPreferenceTreeClick(
		...
		if (KEY_ABOUT_LICENSE.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.LICENSE_URL)));
			finish();
			...
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.CREDITS_BITCOINJ_URL)));
			finish();
		} else if (KEY_ABOUT_CREDITS_ZXING.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.CREDITS_ZXING_URL)));
			finish();
		} else if (KEY_ABOUT_CREDITS_ICON.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.CREDITS_ICON_URL)));
			finish();
		} else if (KEY_ABOUT_AUTHOR_TWITTER.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.AUTHOR_TWITTER_URL)));
			finish();
		} else if (KEY_ABOUT_AUTHOR_GOOGLEPLUS.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.AUTHOR_GOOGLEPLUS_URL)));
			finish();
		} else if (KEY_ABOUT_DISCLAIMER.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.DISCLAIMER)));
			finish();
		} else if (KEY_ABOUT_PIVACY.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.PRIVACY_POLICY)));
			finish();
		} else if (KEY_ABOUT_BITCOIN_WALLET_FOR_ANDROID.equals(key)) {
			startActivity(new Intent(Intent.ACTION_VIEW,
					Uri.parse(Constants.CREDITS_BITCON_WALLET_ANDROID)));
			finish();
		}
